...
class DemandeController implements ControllerInterface
{
    /**
     * @throws SyntaxError
     * @throws RuntimeError
    ...
    public function execute(Request $request)
    {
        ...
        try {
            ...
            //TODO si t'as le temps mon frere (benjamin) fait la liste des matières dans le sql
        ...
        elseif ($errorCode != 0){
            echo $twig->render('home/demande.html.twig', [
                'visu' => false,
                'error'=>$error
            ]);
        }
